...
class TestPrepareFunction(unittest.TestCase):
    ...
    @patch(
        "qiskit_ibm_runtime.executor.routines.estimator_v2.estimator_v2.generate_boxing_pass_manager"
    )
    def test_prepare_passes_twirling_values_to_boxing_pass_manager(self, mock_generate_boxing_pm):
        ...
        with patch(
            "qiskit_ibm_runtime.executor.routines.estimator_v2.estimator_v2.build",
